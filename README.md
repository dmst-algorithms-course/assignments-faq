...
GitHub είναι μία υπηρεσία, που ανήκει στην εταιρεία Microsoft, οποία
παρέχει τέτοια αποθετήρια. Τα παρέχει δωρεάν όταν είναι δημόσια, επί
πληρωμή όταν είναι ιδιωτικά, εκτός από εξαιρέσεις υπό προϋποθέσεις,
όπως ακαδημαϊκή χρήση.
...
```bash
diff -b my_program_results solution_example
```
