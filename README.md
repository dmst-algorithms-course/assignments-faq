...
Επίσης γραμμή εντολών δίνει και η διανομή Anaconda.
...
## <a name="github-desktop"></a>Εκτός από τη γραμμή εντολών, υπάρχει
άλλος τρόπος να δουλέψω με το Git στο GitHub; 
